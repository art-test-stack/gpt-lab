from gpt_lab.utils.common import get_banner, print0, run_command
...
def generate_header():
    ...
    header = f"""# gpt-lab training report
    ...
    def generate(self):
        ...
        with open(report_file, "w", encoding="utf-8") as out_file:
            ...
            if os.path.exists(header_file):
                ...
                print0(f"Warning: {header_file} does not exist. Did you forget to run `gptlab reset`?")
